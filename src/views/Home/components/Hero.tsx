...
export const Hero = () => {
	return (
		<main className="container mx-auto">
			<div className="responsive-padding mt-20 lg:mt-28 flex flex-col lg:items-center lg:flex-row gap-8">
				<div className="lg:mt-28 flex flex-col gap-8">
					<div className="w-full lg:max-w-[521px]">
						<h1 className="uppercase text-5xl lg:text-7xl">Łączy nas</h1>
					...
					<button
						id="pobierz"
						type="button"
						className="text-background bg-primary hover:bg-primaryDarker focus:ring-4 focus:ring-primaryLighter focus:outline-none rounded-lg lg:w-fit  px-7 py-4 font-black text-2xl lg:text-base w-full"
					>
						Pobierz aplikację
					</button>
				</div>
