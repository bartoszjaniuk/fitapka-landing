...
const Toggler = () => {
  ...
  return (
    <div className="flex gap-4">
      <div className="max-h-[481px] bg-primary rounded-lg w-full  flex flex-col">
        <div className="flex p-4 ">
          ...
          <h2 className="uppercase text-background text-4xl">TRENUJĄCY</h2>
        </div>
        <div className="flex  justify-center items-end h-full">
          <img className="h-[90%] " src="/assets/mission1.png" />
        </div>
      </div>
...
const Step = () => {
  return (
    <div className="bg-black rounded-lg p-8 flex flex-col gap-3 h-full">
      <h5 className="font-bold text-xl">Krok 1</h5>
      <p>Zaznacz jaki trening oferujesz oraz okreśł swoją dostępność!</p>
    </div>
  );
};
